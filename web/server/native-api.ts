...
export interface NativeEndpoint {
  version: string;
  capabilities?: { popup_sessions?: boolean; command_execution?: boolean; command_catalog?: boolean; semantic_notifications?: boolean; workspace_git_status?: boolean };
...
export async function nativeEndpoint(machine: Machine): Promise<NativeEndpoint> {
  ...
  return {
    ...
    capabilities: { popup_sessions: status.server.capabilities?.popup_sessions === true, command_execution: status.server.capabilities?.command_execution === true, command_catalog: status.server.capabilities?.command_catalog === true, workspace_git_status: status.server.capabilities?.workspace_git_status === true, semantic_notifications: status.server.capabilities?.semantic_notifications === true },
